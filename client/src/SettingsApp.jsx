                  ...
                  <CardContent className="space-y-4">
                    <div className="flex items-center justify-between">
                      <SettingWithTooltip
                        ...
                        tooltip="Apply custom colors to GitHub's interface. Changes will be visible on all GitHub pages once saved."
                      />
                      <Switch
                        id="theme-enabled"
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-2">
                          ...
                          <Tooltip>
                            ...
                            <TooltipContent>
                              <p>Secondary color for hover states and accents</p>
                            </TooltipContent>
                          </Tooltip>
                        </div>
                        <div className="flex items-center gap-2">
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-2">
                          ...
                          <Tooltip>
                            ...
                            <TooltipContent>
                              <p>Main background color for GitHub pages</p>
                            </TooltipContent>
                          </Tooltip>
                        </div>
                        <div className="flex items-center gap-2">
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-2">
                          ...
                          <Tooltip>
                            ...
                            <TooltipContent>
                              <p>Default text color for content</p>
                            </TooltipContent>
                          </Tooltip>
                        </div>
                        <div className="flex items-center gap-2">
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex-1">
                        <div className="flex items-center gap-2">
                          ...
                          <Tooltip>
                            ...
                            <TooltipContent className="max-w-xs">
                              <p>
                                Adds detailed statistics when hovering over contribution squares,
                                including commit counts and activity breakdown.
                              </p>
                            </TooltipContent>
                          </Tooltip>
                        </div>
                      ...
                      <Switch
                        ...
                        onCheckedChange={(checked) =>
                          updateEnhancement("contributionStats", checked)
                        }
                      />
                    </div>
                    <div className="flex items-center justify-between">
                      <div className="flex-1">
                        <div className="flex items-center gap-2">
                          ...
                          <Tooltip>
                            ...
                            <TooltipContent className="max-w-xs">
                              <p>
                                Displays additional metrics like stars, forks, and language
                                breakdown directly on repository cards.
                              </p>
                            </TooltipContent>
                          </Tooltip>
                        </div>
                        <p className="text-xs text-muted-foreground">
                          Add quick stats to repo cards
                        </p>
                      </div>
                      <Switch
                      ...
                      <div className="flex-1">
                        <div className="flex items-center gap-2">
                          ...
                          <Tooltip>
                            ...
                            <TooltipContent className="max-w-xs">
                              <p>
                                Shows additional profile insights including contribution streaks,
                                activity patterns, and detailed statistics.
                              </p>
                            </TooltipContent>
                          </Tooltip>
                        </div>
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-2">
                        ...
                        <Tooltip>
                          ...
                          <TooltipContent className="max-w-xs">
                            <p>
                              Customize the font family and size for code blocks across GitHub.
                      ...
                      <div>
                        <div className="flex items-center gap-2 mb-2">
                          ...
                          <Tooltip>
                            ...
                            <TooltipContent>
                              <p>
                                Choose a monospace font for code display. Popular options include
                        ...
                        <div className="flex items-center justify-between mb-2">
                          <div className="flex items-center gap-2">
                            ...
                            <Tooltip>
                              ...
                              <TooltipContent>
                                <p>Adjust the size of code text. Recommended range: 12-18px</p>
                              </TooltipContent>
                            </Tooltip>
                          </div>
                        </div>
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-2">
                        ...
                        <Tooltip>
                          ...
                          <TooltipContent className="max-w-xs">
                            <p>
                              Enable keyboard shortcuts for faster navigation and actions on GitHub.
                              Press the key combinations below to trigger actions instantly.
                            </p>
                          </TooltipContent>
                        </Tooltip>
                      </div>
                  ...
                  <CardHeader>
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <CardDescription>
                          Quick access to your favorite repositories
                        </CardDescription>
                      </div>
