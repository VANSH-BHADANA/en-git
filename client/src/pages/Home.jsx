...
const Home = () => {
  ...
  return (
    <div className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      ...
      <h1 className="text-2xl sm:text-3xl font-bold mb-6">Live Transaction Feed</h1>
        ...
        <Table>
          <TableHeader>
            <TableRow>
              ...
              <TableHead className="min-w-[150px] hidden sm:table-cell">Razorpay ID</TableHead>
              <TableHead className="min-w-[150px] hidden md:table-cell">Date</TableHead>
              <TableHead className="min-w-[150px] hidden lg:table-cell">Blockchain Hash</TableHead>
            </TableRow>
          </TableHeader>
          <TableBody>
